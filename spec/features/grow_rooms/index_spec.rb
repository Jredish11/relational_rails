...
RSpec.describe "/grow_rooms", type: :feature do
  #User Story 1
  describe "as a visitor, when I visit grow_room index page" do
  ...
  save_and_open_page
      ...
      expect(page).to have_content(room_2.name) #is this okay? i planned to name each grow_room like this
